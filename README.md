...
If you want to use compressed file to install manually, you can unzip it (e.g.: obs-rtspserver-v1.3.0-windows.zip) and put it to your obs-studio install folder.
...
* Untar, e.g.: tar -xzvf obs-rtspserver-v1.3.0-linux.tar.gz -C $HOME/.config/obs-studio/plugins/
